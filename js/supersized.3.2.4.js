        ...
        base._placeSlide = function(place){
			...
			if (place == 'next'){
				...
				if (!$(targetList).html()){
					...
					/* original supersized image + link builder (a href)
					imageLink = (base.options.slides[loadSlide].url) ? "href='" + base.options.slides[loadSlide].url + "'" : "";	// If link exists, build it
					var img = $('<img src="'+base.options.slides[loadSlide].image+'"/>'); 
					...
					*/
					/* new hotness that doesn't make chrome's URL popup hide the nav footer */
					imageLink = (base.options.slides[loadSlide].url) ? "onClick='document.location.replace(\""+ . base.options.slides[loadSlide].url "\")'";	// If link exists, build it
					var img = $('<img src="'+base.options.slides[loadSlide].image+'"/>'); 
					
					img.appendTo(targetList).wrap('<span ' + imageLink +  + '></span>').parent().parent().addClass('image-loading').css('visibility','hidden');
